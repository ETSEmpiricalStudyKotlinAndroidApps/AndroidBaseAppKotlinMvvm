...
import co.androidbaseappkotlinmvvm.commons.ui.base.BasePagedListAdapter
...
/**
 * Class for presenting movies List data in a [RecyclerView], including computing
...
class MoviesListAdapter @Inject constructor(
...
) : BasePagedListAdapter<MovieItem>(
    itemsSame = { old, new -> old.id == new.id },
    contentsSame = { old, new -> old == new }
) {

    private var state: MoviesListAdapterState = MoviesListAdapterState.Added
     ...
     */
    fun submitState(newState: MoviesListAdapterState) {
        val oldState = state
        state = newState
