...
import co.androidbaseappkotlinmvvm.dynamicfeatures.characterslist.databinding.FragmentMoviesListBinding
...
class MoviesListFragment :
    ...
    override fun onInitDependencyInjection() {
        DaggerMoviesListComponent
            ...
            .charactersListModule(MoviesListModule(this))
            .build()
            .inject(this)
    }
    ...
    private fun onViewEvent(viewEvent: MoviesListViewEvent) {
        when (viewEvent) {
            is MoviesListViewEvent.OpenCharacterDetail ->
                findNavController().navigate(
                    MoviesListFragmentDirections
                        .actionMoviesListFragmentToMovieDetailFragment(viewEvent.id))
        }
    }
}
