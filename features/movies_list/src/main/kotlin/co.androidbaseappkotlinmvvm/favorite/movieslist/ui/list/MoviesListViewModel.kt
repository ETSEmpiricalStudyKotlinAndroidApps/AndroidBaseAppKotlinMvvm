...
import co.androidbaseappkotlinmvvm.favorite.movieslist.ui.list.paging.PAGE_MAX_ELEMENTS
...
@Inject constructor(
    ...
    fun openCharacterDetail(characterId: Long) {
        event.postValue(MoviesListViewEvent.OpenCharacterDetail(characterId))
    }
}
