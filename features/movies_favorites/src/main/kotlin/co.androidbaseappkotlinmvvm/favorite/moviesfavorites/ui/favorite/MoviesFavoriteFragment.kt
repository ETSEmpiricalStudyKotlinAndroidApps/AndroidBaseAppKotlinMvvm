...
import co.androidbaseappkotlinmvvm.dynamicfeatures.charactersfavorites.databinding.FragmentMoviesFavoriteListBinding
...
class MoviesFavoriteFragment :
    ...
    override fun onInitDependencyInjection() {
        DaggerMoviesFavoriteComponent
            ...
            .charactersFavoriteModule(MoviesFavoriteModule(this))
            .build()
            .inject(this)
    }
