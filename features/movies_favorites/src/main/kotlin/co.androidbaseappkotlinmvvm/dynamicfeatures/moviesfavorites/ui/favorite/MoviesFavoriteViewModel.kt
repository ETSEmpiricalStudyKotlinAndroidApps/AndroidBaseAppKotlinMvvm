...
class MoviesFavoriteViewModel @Inject constructor(
    ...
    /**
     * Remove the selected favorite movie from database in case if exist.
     *
     * @param movie Favorite movie.
     */
    fun removeFavoriteMovie(movie: MovieFavorite) {
        viewModelScope.launch {
            movieFavoriteRepository.deleteMovieFavorite(movie)
        }
    }
}
