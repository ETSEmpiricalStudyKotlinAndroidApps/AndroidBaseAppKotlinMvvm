...
package co.androidbaseappkotlinmvvm.commons.ui.livedata
...
import co.androidbaseappkotlinmvvm.libraries.testutils.lifecycle.TestLifecycleOwner
...
class SingleLiveDataTest {
    ...
    fun observingSingleLiveData_WhenPostMultipleIntValue_ShouldTriggerMultipleTimes() {
        val singleLiveData = co.androidbaseappkotlinmvvm.commons.ui.livedata.SingleLiveData<Int>()
