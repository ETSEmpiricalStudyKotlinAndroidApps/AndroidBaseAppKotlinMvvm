...
package co.androidbaseappkotlinmvvm.commons.ui.base
...
class BaseFragmentTest : TestRobolectric() {
    ...
    class TestBaseFragment : co.androidbaseappkotlinmvvm.commons.ui.base.BaseFragment<ViewDataBinding, ViewModel>(
        layoutId = 0
    ) {
